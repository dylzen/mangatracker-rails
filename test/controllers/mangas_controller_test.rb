...
class MangasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manga" do
    assert_difference("Manga.count") do
      post mangas_url, params: { manga: { collection: @manga.collection, mis_vols: @manga.mis_vols, own_vols: @manga.own_vols, pub_vols: @manga.pub_vols, status: @manga.status, title: @manga.title } }
    end
  ...
  test "should update manga" do
    patch manga_url(@manga), params: { manga: { collection: @manga.collection, mis_vols: @manga.mis_vols, own_vols: @manga.own_vols, pub_vols: @manga.pub_vols, status: @manga.status, title: @manga.title } }
